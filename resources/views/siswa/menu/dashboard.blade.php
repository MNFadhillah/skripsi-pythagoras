                            ...
                            <div class="progress flex-grow-1" style="height: 8px;">
                                <div class="progress flex-grow-1" style="height: 8px;">
                                    <div class="progress-bar bg-success"
                                        role="progressbar"
                                        @style([ 'width: ' .$totalProgressKeseluruhan.'%'
                                        ])>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="bg-white rounded-3 p-4 mb-4 shadow-sm border">
                    ...
                    <div class="mt-4 pt-3 border-top">
                        ...
                        <div class="progress rounded-pill bg-light border" style="height: 14px;">
                            <div class="progress-bar progress-bar-striped progress-bar-animated rounded-pill {{ $totalProgressKeseluruhan == 100 ? 'bg-success' : 'bg-primary' }}" role="progressbar" @style([ 'width: ' .$totalProgressKeseluruhan.'%'])>
                            </div>
                        </div>
                    </div>
                </div>
...
<style>
    ...
    .badge-modal-img {
        ...
        cursor: help;
        /* Kursor berubah jadi tanda tanya/bantuan */
    }
    ...
    .custom-badge-tooltip {
        ...
        pointer-events: none;
        margin-bottom: 15px;
        /* Jarak antara tooltip dan gambar lencana */
    }
